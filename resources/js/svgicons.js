/**
 * svgicons.js v1.0.0
 * based on demo from http://www.codrops.com
 *
...
var svgIconConfig = {
		more : { 
		url : 'resources/img/more.svg',
		animation : [
			{ 
				el : 'g:nth-child(2) path:nth-child(1)', 
				animProperties : { 
			...
			{ 
				el : 'g:nth-child(2) path:nth-child(2)', 
				animProperties : { 
	...
	moreLTS : { 
		url : 'resources/img/more-support.svg',
		animation : [
			{
				el : 'g:nth-child(2) path:nth-child(1)', 
				animProperties : { 
...
;( function( window ) {
	...
	svgIcon.prototype.toggle = function( motion ) {
		if(this.config.attr) {
		    for( var i = 0, len = this.config.attr.length; i < len; ++i ) {  
		        var attr = this.config.attr[i];
